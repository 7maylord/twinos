...
export default function RecommendationPanel() {
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
      ...
      <button className="w-full mt-6 py-2.5 px-4 border border-black text-black rounded-full font-medium hover:bg-gray-50 transition-colors duration-200 text-sm">
        View Full Report
      </button>
    </div>
  );
